...
public class HiredOnFragment extends Fragment {
    ...
    private AsyncTask getHiredOn;

    public static HiredOnFragment newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        HiredOnFragment fragment = new HiredOnFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_hired_on, container, false);

        rv = (RecyclerView) view.findViewById(R.id.hired_on_recycler);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getHiredOn = new getHiredOnProjects().execute("getHiredOnProjects", userDetails.get("id"));
    }
    ...
    public void onStop() {
        ...
        getHiredOn.cancel(true);
    }

    class getHiredOnProjects extends AsyncTask<String, String, JSONObject> {

        JSONParser jsonParser = new JSONParser();
        JSONObject json;

        private ProgressBar hiredOnProgBar;
        ...
        protected void onPreExecute() {
            hiredOnProgBar = (ProgressBar) getView().findViewById(R.id.hiredOnProgBar);
            hiredOnProgBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            hiredOnProgBar.setVisibility(View.GONE);
