...
public class ClosedNegotiationFragment extends Fragment {
    public static final String ARG_PAGE = "ARG_PAGE";

    private int mPage;

    private List<NegotiationCard> closed_negotiations;
    private RecyclerView closed_neg_rv;
    ...
    private final int NEG_STATUS = 0;

    public static ClosedNegotiationFragment newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        ClosedNegotiationFragment fragment = new ClosedNegotiationFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //initializing
        closed_negotiations = new ArrayList<>();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_closed_negotiation, container, false);

        closed_neg_rv = (RecyclerView) view.findViewById(R.id.closed_negotiation_recycler);
        LinearLayoutManager llm = new LinearLayoutManager(getContext());
        closed_neg_rv.setLayoutManager(llm);
        closed_neg_rv.setHasFixedSize(true);
    ...
    class getNegotiations extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            if(json != null) {
                try {
                    ...
                    for(int i = 0; i < negotiationz.length(); i++) {
                        ...
                        closed_negotiations.add(new NegotiationCard(negotiationObj.getString(TAG_IMAGE),negotiationObj.getString(TAG_TITLE),
            ...
            if(success == 1) {
                if(exist == 1) {
                    adapter = new NegotiationAdapter(closed_negotiations);

                    closed_neg_rv.setAdapter(adapter);
                }
            } else {
                if(!errormsg.equals("")) {
